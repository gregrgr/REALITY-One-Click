...
collect_install_config() {
  ...
  set_default CLASH_RULE_PROVIDERS_ENABLED "${CLASH_RULE_PROVIDERS_ENABLED:-yes}"
  set_default CLASH_RULE_PROVIDER_BASE_URL "${CLASH_RULE_PROVIDER_BASE_URL:-https://cdn.jsdelivr.net/gh/Loyalsoldier/clash-rules@release}"
  set_default CLASH_RULE_PROVIDER_INTERVAL "${CLASH_RULE_PROVIDER_INTERVAL:-86400}"
...
render_template() {
  ...
  local vars=(
    ...
    CLASH_RULE_PROVIDERS_ENABLED CLASH_RULE_PROVIDER_BASE_URL CLASH_RULE_PROVIDER_INTERVAL
  )
